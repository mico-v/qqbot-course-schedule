...
func (c *Client) sendMedia(ctx context.Context, path, fileInfo, msgID string, msgSeq int) error {
	if msgID == "" {
		msgSeq = 0
	}
	body := mediaMessage{MsgType: 7, Media: mediaContent{FileInfo: fileInfo}, MsgID: msgID, MsgSeq: msgSeq}
