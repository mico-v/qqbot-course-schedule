<!-- source: https://bot.q.qq.com/wiki/develop/api-v2/server-inter/message/rich-media.html -->
...
![img](https://qq-ai.cdn-go.cn/web/bot-docs/-/v1.30.1/assets/img/im) ![img](https://qq-ai.cdn-go.cn/web/bot-docs/-/v1.30.1/assets/img/vo) ![img](https://qq-ai.cdn-go.cn/web/bot-docs/-/v1.30.1/assets/img/vi) ![img](https://qq-ai.cdn-go.cn/web/bot-docs/-/v1.30.1/assets/img/la)
...
整文件上传使用 单聊上传 / 群聊上传 接口，直接传入文件 URL；文件较大时使用分片上传，参考 单聊预上传 开始分片流程。
