<!-- source: https://bot.q.qq.com/wiki/develop/api-v2/server-inter/channel/miniapp/interface.html -->
...
res 得到的是加密之后的数据，需要开发者解密，解密方案参考: 开放数据校验与解密 (opens new window)
